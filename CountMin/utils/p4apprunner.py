...
def run_compile_bmv2(manifest):
    ...
    rv = run_command('/home/wsc/p4/p4-guide/bin/p4c/build/backends/bmv2/p4c-bm2-ss %s' % ' '.join(compiler_args))
...
#        print(file=message)
    ...
    return run_command('sudo python2 %s %s' % (program, ' '.join(switch_args)))
